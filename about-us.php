    ...
    <main id="content">
      <section style="background-image: url('images/bg-about-us.jpg')"
        ...
        <div class="container position-relative z-index-2 text-center">
          <div class="mxw-751">
            <h1 class="text-white fs-30 fs-md-42 lh-15 font-weight-normal mt-4 mb-10" data-animate="fadeInRight">Welcome to Ngaru Logistics Ltd, where land meets opportunity</h1>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="card border-0 mt-n13 z-index-3 mb-12">
            <div class="card-body p-6 px-lg-14 py-lg-13">
              <p class="letter-spacing-263 text-uppercase text-primary mb-6 font-weight-500 text-center">About Ngaru</p>
              ...
              Founded with a vision to redefine the land-buying experience, we are dedicated to helping individuals, 
              families, and investors find the perfect piece of land for their unique needs.
              </p>
            </div>
          </div>
          <h2 class="text-dark lh-1625 text-center mb-2 fs-22 fs-md-32">Why we are the best</h2>
          ...
          <div class="row mt-8">
              ...
              <div class="card shadow-2 px-7 pb-6 pt-4 h-100 border-0">
                <div class="card-img-top d-flex align-items-end justify-content-center">
                  <span class="text-primary fs-90 lh-1">
                    <svg class="icon icon-e2"><use xlink:href="#icon-e5"></use></svg>
                  </span>
                </div>
                <div class="card-body px-0 pt-6 pb-0 text-center">
            ...
            <div class="col-md-4 mb-6 mb-lg-0">
              <div class="card shadow-2 px-7 pb-6 pt-4 h-100 border-0">
                <div class="card-img-top d-flex align-items-end justify-content-center">
                  <span class="text-primary fs-90 lh-1">
                    <svg class="icon icon-e3"><use xlink:href="#icon-e6"></use></svg>
                  </span>
                </div>
                <div class="card-body px-0 pt-6 text-center pb-0">
                  <h4 class="card-title fs-18 lh-17 text-dark mb-2">Ready title deeds</h4>
                  <p class="card-text px-2">
