...
<html lang="en">
  <head>
    ...
    <title>Blog Grid with Sidebar - Ngaru</title>
    <!-- Google fonts -->
    ...
    <meta name="twitter:title" content="Blog Grid with Sidebar">
    <meta name="twitter:description" content="Ngaru Logistics Ltd">
    <meta name="twitter:image" content="images/homeid-social-logo.png">
    <!-- Facebook -->
    <meta property="og:url" content="blog-grid-with-sidebar.html">
    <meta property="og:title" content="Blog Grid with Sidebar">
  ...
  <body>
    ...
    ?>
    <main id="content">
      <section class="py-16 page-title bg-white-overlay bg-img-cover-center"
         style="background-image: url('images/bg-title-04.jpg');">
        <div class="container">
          <h1 class="fs-42 lh-15 mb-0 text-heading font-weight-500 text-center mxw-521 py-3" data-animate="fadeInDown">Latest news are on
            top all times</h1>
        </div>
      </section>
      <section class="py-13">
                ...
                <div class="col-md-6">
                  <div class="card border-0 pb-8">
                    ...
                    <div class="card-body p-0">
                      ...
                      <h3 class="fs-18 text-heading lh-194 mb-2">
                        <a href="blog-single" class="text-heading hover-primary">Future Office Buldings Intelligent by Design</a>
                      </h3>
                      <a class="text-heading font-weight-500" href="blog-single">Learn
                        more <i
