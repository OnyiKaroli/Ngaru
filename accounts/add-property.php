        ...
        $insert = mysqli_query($server, "INSERT INTO `properties`(`name`, `location`, `price`, `deposit`, `featured`, `size`, `agent`, `status`) 
            ...
            if ($insert) {
              echo "<div class='alert alert-success alert-dismissible' role='alert'>
                ...
                <strong>Successfully</strong> Property added.
              </div>";
...
?>             
              ...
              <form role="form" method="post" enctype='multipart/form-data'>
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="0" class="form-control" name="price" required="" placeholder="Price">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Deposit*</label>
                    <input type="number" min="0" class="form-control" name="deposit" required="" placeholder="Deposit">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Size*</label>
                    <input type="number" min="0" class="form-control" name="size" required="" placeholder="Size">
                </div>
                <div class="form-group">
...
?>
                ...
                <div class="card-footer">
                  <button type="submit" name="add_property" class="btn btn-primary">Proceed</button>
                </div>
              </form>
            </div>
          </div>
