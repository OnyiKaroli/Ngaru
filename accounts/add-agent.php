...
<head>
  ...
  <title>Ngaru Logistics Ltd || Add Staff</title>
  ...
  if (isset($_POST['add'])) {
    ...
    if($password !== $repassword){
         ...
         <div class='alert alert-danger alert-dismissible' role='alert'>
                    ...
                    <strong>Passwords</strong> do not match. Try again.
                  </div>";
    }else{
      ...
      $insert = mysqli_query($server, "INSERT INTO `users`(`firstname`, `lastname`, `email`, `password`, `type`, `branch_id`) VALUES ('$firstname', '$lastname', '$email', '$password', '$type', '$branch_id')") or die(mysqli_error($server));
...
?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" name="repassword" required="" class="form-control" placeholder="password">
                  </div>
                </div>
                <!-- /.card-body -->
