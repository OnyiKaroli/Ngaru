...
<html lang="en">
  <head>
    ...
    <title>Full Width Grid 2 - HomeID</title>
    <!-- Google fonts -->
      ...
      <section class="pb-4 page-title shadow">
        <div class="container container-xxl">
          <nav aria-label="breadcrumb">
            ...
            <h1 class="fs-30 lh-1 mb-0 text-heading font-weight-600">Full Width Grid 2</h1>
        ...
        <div class="container container-xxl">
          <div class="row mx-n2">
            <div class="col-xxl-3 col-lg-4 col-md-6 mb-7 px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image ">
                <div class="bg-hover-overlay rounded-lg card-img">
                  <img src="images/properties-grid-56.jpg" alt="Home in Metric Way">
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 mb-7 px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image ">
                <div class="bg-hover-overlay rounded-lg card-img">
                  <img src="images/properties-grid-57.jpg" alt="Garden Gingerbread House">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 mb-7 px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image ">
                <div class="bg-hover-overlay rounded-lg card-img">
                  <img src="images/properties-grid-58.jpg" alt="Affordable Urban House">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div>
                      <span class="badge badge-indigo">for Rent</span>
                    </div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 mb-7 px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image ">
                <div class="bg-hover-overlay rounded-lg card-img">
                  <img src="images/properties-grid-66.jpg" alt="Villa on Hollywood Boulevard">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div>
                      <span class="badge badge-indigo">for Rent</span>
                    </div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 mb-7 px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image ">
                <div class="bg-hover-overlay rounded-lg card-img">
                  <img src="images/properties-grid-51.jpg" alt="Affordable Urban House">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div>
                      <span class="badge badge-indigo">for Rent</span>
                    </div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 mb-7 px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image ">
                <div class="bg-hover-overlay rounded-lg card-img">
                  <img src="images/properties-grid-52.jpg" alt="Explore Old Barcelona">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div>
                      <span class="badge badge-primary">For Sale</span>
                    </div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 mb-7 px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image ">
                <div class="bg-hover-overlay rounded-lg card-img">
                  <img src="images/properties-grid-53.jpg" alt="Home in Metric Way">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div>
                      <span class="badge badge-indigo">for Rent</span>
                    </div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 mb-7 px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image ">
                <div class="bg-hover-overlay rounded-lg card-img">
                  <img src="images/properties-grid-54.jpg" alt="Home in Metric Way">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div>
                      <span class="badge badge-primary">For Sale</span>
                    </div>
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 mb-7 px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image ">
                <div class="bg-hover-overlay rounded-lg card-img">
                  <img src="images/properties-grid-55.jpg" alt="Home in Metric Way">
                  <div class="card-img-overlay p-2 d-flex flex-column">
                    <div>
                      <span class="badge badge-primary">For Sale</span>
                    </div>
            ...
            <div class="col-12 text-center mt-1">
              <a href="#" class="btn btn-lg btn-outline-accent text-heading shadow-none border-2x d-inline-flex align-items-center">View more
