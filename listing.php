...
<html lang="en">
  <head>
    ...
    <title>Properties on Sale - Ngaru</title>
    <!-- Google fonts -->
    ...
    <main id="content">
      <section class="pb-4 page-title shadow">
        <div class="container container-xxl">
          <nav aria-label="breadcrumb">
            ...
            <h1 class="fs-30 lh-1 mb-0 text-heading font-weight-600">View our properties</h1>
          </nav>
        </div>
      </section>
      <section class="pt-6 pb-7">
        <div class="container container-xxl">
          <div class="row align-items-sm-center">
            <div class="col-md-6">
              <h2 class="fs-15 text-dark mb-0">The following properties are available for you
              </h2>
            </div>
      ...
      <section class="pb-11">
        <div class="container container-xxl">
          <div class="row mx-n2">
            <?php
              $select = mysqli_query($server, "SELECT * FROM `properties` ORDER BY `id` ASC LIMIT 12") or die(mysqli_error($server));
            ...
            <div class="col-xxl-3 col-lg-4 col-md-6 mb-7 px-2" data-animate="fadeInUp">
              <div class="card border-0 hover-change-image ">
                <div class="bg-hover-overlay rounded-lg card-img">
                  <img src="images/properties-grid-56.jpg" alt="<?php echo $row['name']; ?>">
                ...
                <div class="card-body pt-3 px-0 pb-1">
                  <?php echo"<h2 class='fs-16 mb-1'><a href='single-property?did=".$row['id']."' class='text-dark hover-primary'>".$row['name']."</a></h2>";?>
                  <p class="font-weight-500 text-gray-light mb-1"><?php echo $row['location']; ?></p>
